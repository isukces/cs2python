...
#warning 'Be careful in LINUX'
        ...
        public void Compile()
        {
            using(var comp = PreparePyCompiler())
            {
                var emitResult = comp.Compile2PyAndEmit(_outDir, DllFilename, ReferencedPyLibsLocations);
        ...
        public void Set1(string[] referenced, string[] tranlationHelpers, string[] a)
        {
            ...
            ReferencedPyLibsLocations = (from i in a
                select i.Split('\n')
        ...
        /// <summary>
        ///     Location of referenced libraries in Py, taken from compiler commandline option
        /// </summary>
        ...
        private readonly string _tempDir =
            Path.Combine(Path.GetTempPath(), "cs2Py" + Guid.NewGuid().ToString("D"));
