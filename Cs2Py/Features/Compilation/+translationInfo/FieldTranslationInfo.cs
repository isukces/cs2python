...
namespace Cs2Py.Compilation
{
    public class FieldTranslationInfo
    {
                    ...
                    if (moduleAttribute != null)
                    {
                        if (!isFieldOutsideClass)
                            throw new Exception(string.Format(
                                ...
                                fieldInfo.ExcName()));
                        fti.IncludeModule = new PyCodeModuleName(moduleAttribute.ModuleShortName,
        ...
        ///     Własność jest tylko do odczytu.
        /// </summary>
        public bool IsScriptNamePyEncoded { get; private set; }
        ...
        ///     Własność jest tylko do odczytu.
        /// </summary>
        public PyCodeModuleName IncludeModule { get; private set; }
