...
namespace Cs2Py.CSharp
{
    ...
    public sealed partial class FullClassDeclaration : CSharpBase {
    ...
    public sealed partial class FullInterfaceDeclaration : CSharpBase {
...
public class CSharpBaseVisitor<T> {
        public T Visit(CSharpBase a)
        {
            switch (a.TokenKind)
            {
                ...
                case CSharpBaseKinds.FullClassDeclarationKind:
